...
title = Label(root, text="WELCOME TO TULU TYPING TUTOR", font=("Times New Roman", 20), bg=background_color)
title.grid(row=0, column=0, padx=42, pady=20, columnspan=2)

tulu_text_font = ("TULUSRI Regular", 25)
display_current_letter = Label(root, font=tulu_text_font, bg=background_color)
display_remaining_text = Label(root, font=tulu_text_font, bg=background_color)
...
score_label.grid(row=6, column=0, columnspan=2, padx=20, sticky="w")
...
percentage_label.grid(row=7, column=0, columnspan=2, padx=20, pady=10, sticky="w")
